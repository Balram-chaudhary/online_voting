             ...
             <input type="hidden" name="_token" id="token" value="{{csrf_token()}}" >
              ...
              <div class="form-group">
                   <label for="pname" class="col-sm-2 control-label">Nominee Name</label>
                    <div class="col-sm-10">
                    <div class="col-sm-10">
                    <input type="text"  name="name" id="name" placeholder="Enter Nominee Name" value="{{old('name')}}" required="required" class="form-control">
                  ...
                  <div class="form-group">
                   <label for="pname" class="col-sm-2 control-label">Party Name</label>
                    <div class="col-sm-10">
                    <div class="col-sm-10">
                    <input type="text"  name="pname" id="pname" placeholder="Enter Party Name" value="{{old('pname')}}" required="required" class="form-control">
                 ...
                 <div class="form-group">
                   <label for="licence" class="col-sm-2 control-label">Licence Id</label>
                    <div class="col-sm-10">
                    <input type="text"  name="licence" id="licence"  value="{{old('licence')}}" placeholder="Enter Enter Licence Number" required="required" class="form-control" >
               ...
               <div class="form-group">
                  ...
                  <select name="post" id="post" required="required" class="form-control">
                   ...
                   <option value="ds">Deputy General Secretary</option>
               ...
               <div class="form-group">
                   <label for="licence" class="col-sm-2 control-label">Address</label>
                    <div class="col-sm-10">
                    <input type="text"  name="address" id="address"  value="{{old('address')}}" placeholder="Enter Enter Address" required="required" class="form-control" >
